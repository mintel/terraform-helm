...
*/}}
{{- define "terraform.pdb.maxUnavailable" -}}
...
*/}}
{{- define "terraform.extraEnvironmentVars" -}}
...
{{- define "terraform.getRole" -}}
  {{- if or .Values.syncWorkspace.watchAllNamespaces (or (empty .Values.syncWorkspace.k8WatchNamespace)) }}
    {{- "ClusterRole" }}
  {{- else }}
    {{- "Role" }}
  {{- end }}
